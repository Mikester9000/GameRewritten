...
- 2026-05-13: Cleanup: Narrative code pass — Surge rename, duplicate DamageNumbers removed, test draw calls removed, Main loop reorganised as nine-step narrative, short variable names expanded, narrative code style written permanently into agent rules
